...
function Homepage() {
  ...
  const handleSlideChangea = (event) => {
    const target = event.target;

    // Retrieve the index of the slide you want to show
    const slideIndex = Number(target.getAttribute('data-slide-index'));

    // Change the active slide using the Owl Carousel API
        ...
        <div className="services_sec py-5">
          <div className="container custom_container">
            ...
            <div className="desktop-view d-none d-xl-block">
              ...
              <OwlCarousel className='owl-theme' ref={carouselRef} id="owl_services" loop margin={10} nav

                {...options1}>
                {servicedata.map((e, i) => (

                  <div className="item" key={i} data-index={i} data-slide-index={i}>
                  ...
                  {servicedata.map((e, i) => (
                    <div className="col-lg-6">
                      ...
                      <ul id="scroll_ul_list" >
                        ...
                        {i == selectedindex ?
                          <li data-index={i} className='activelist'>{e.headtitle}</li> :
